...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['middleware' => ['inaccess:fees/setup']], function () {
        ...
        Route::get('/fees/{period_id}/returncopyfeessetup', [FeeController::class, 'returncopyfeessetup']);
    ...
    Route::group(['middleware' => ['inaccess:applications']], function () {
        ...
        Route::post('/applications/updateapplication', [ApplicationController::class, 'update'])->name('applications.update');
        Route::put('/applications/{application}/applicationaction', [ApplicationController::class, 'applicationaction']);
    ...
    Route::group(['middleware' => ['inaccess:admissions']], function () {
        ...
        Route::get('/admissions/returndocuments', [AdmissionController::class, 'returndocuments']);
        Route::get('/admissions/{document}/editdocument', [AdmissionController::class, 'editdocument']);
