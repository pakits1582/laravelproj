    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="font-weight-bold text-primary mb-0">Statement of Account <span id="period_name">{{ session('periodname') }}</span></h6>
            </div>
            <div class="card-body">
                <div class="row">
                                    ...
                                    <div class="row  align-items-end">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group right" id="button_group">
                                                <button type="button" id="print_soa" class="btn btn-sm btn-success btn-icon-split actions mb-2" disabled>
                                                    <span class="icon text-white-50">
                                                        <i class="fas fa-print"></i>
                                                    </span>
                                                    <span class="text">Print Statement of Account</span>
                                                </button>
                                                <button type="button" id="print_permit" class="btn btn-sm btn-primary btn-icon-split actions mb-2" disabled>
                                                    <span class="icon text-white-50">
                                                        <i class="fas fa-print"></i>
                                                    </span>
