<div class="table-responsive" id="table_data">
    <table class="table table-sm table-bordered table-striped" id="instructorTable" width="100%" cellspacing="0">
        <thead>
            <tr>
                <th>#</th>
                <th>ID Number</th>
                    ...
                    <tr>
                        ...
                        <td class="mid">
                            ...
                            @if ($instructor->user->is_active == 1)
                                <a href="#" class="btn btn-danger btn-circle btn-sm user_action" id="{{ $instructor->user_id }}" data-action="deactivate" title="Deactivate">
                                    <i class="fas fa-trash"></i>
                                </a>
                            @else
                                <a href="#" class="btn btn-success btn-circle btn-sm user_action" id="{{ $instructor->user_id }}" data-action="activate" title="Activate">
                                    <i class="fas fa-power-off"></i>
                                </a>  
                            @endif
                            <a href="#" class="btn btn-info btn-circle btn-sm user_action" id="{{ $instructor->user_id }}" data-action="reset" title="Reset Password">
