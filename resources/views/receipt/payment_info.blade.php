    ...
    <div class="row">
        <div class="col-md-9">
            <div class="row align-items-end">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label for="term" class="m-0 font-weight-bold text-primary">Check No.</label>
                        <input type="text" id="educational_level" class="form-control text-uppercase clearable" readonly value="" placeholder="">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="term" class="m-0 font-weight-bold text-primary">Deposite Date</label>
                        <input type="text" id="educational_level" class="form-control text-uppercase clearable" readonly value="" placeholder="">
                    </div>
                </div>
                <div class="col-md-4 mid">
                    <div class="form-group" id="button_group">
                        <button type="submit" id="save_enrollment" class="btn btn-success btn-icon-split actions mb-0" disabled>
                            <span class="icon text-white-50">
                                <i class="fas fa-save"></i>
                            </span>
                            <span class="text">(F2) Add</span>
                        </button>
                        <button type="button" id="delete_selected" class="btn btn-danger btn-icon-split actions mb-0" disabled>
                            <span class="icon text-white-50">
            ...
            <div class="row">
                <div class="col-md-6">
                    <label for="new"  class="m-0 font-weight-bold text-primary checkbox-inline">
                        ...
                        <input type="checkbox" class="checkbox" name="new" value="1" id="new"> Cancel Transaction</label> | 
