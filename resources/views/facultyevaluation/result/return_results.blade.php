<table id="scrollable_table_evaluation_results" class="scroll_table table table-sm table-striped table-bordered hover compact" style="width:100%; font-size:14px !important;">
    <thead>
        <tr>
