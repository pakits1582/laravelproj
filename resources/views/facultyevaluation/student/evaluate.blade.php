        ...
        @else
                                    ...
                                    @foreach ($group['questions'] as $question)
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 mid">
                                                    <label for="choice1_{{ $question['id'] }}" class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="choice[{{ $question['id'] }}]" value="1" id="choice1_{{ $question['id'] }}"> {{ $choice1 }} </label>
                                                </div>
                                                <div class="col-md-3 mid">
                                                    <label for="choice2_{{ $question['id'] }}" class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="choice[{{ $question['id'] }}]" value="2" id="choice2_{{ $question['id'] }}"> {{ $choice2 }} </label>
                                                </div>
                                                <div class="col-md-3 mid">
                                                    <label for="choice3_{{ $question['id'] }}" class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="choice[{{ $question['id'] }}]" value="3" id="choice3_{{ $question['id'] }}"> {{ $choice3 }} </label>
                                                </div>
                                                <div class="col-md-3 mid">
                                                    <label for="choice4_{{ $question['id'] }}" class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="choice[{{ $question['id'] }}]" value="4" id="choice4_{{ $question['id'] }}"> {{ $choice4 }} </label>
                                                </div>
                                            </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="overallrate1" class="m-0 font-weight-bold text-primary">Strong Points</label>
                            <textarea name="" class="form-control" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="overallrate1" class="m-0 font-weight-bold text-primary">Weak Points</label>
                            <textarea name="" class="form-control" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="overallrate1" class="m-0 font-weight-bold text-primary">Suggestions for Improvement</label>
                            <textarea name="" class="form-control" rows="3"></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="overallrate1" class="m-0 font-weight-bold text-primary">Other Student Services</label>
                            <textarea name="" class="form-control" rows="3"></textarea>
                        </div>
                    </div>
                </div>
