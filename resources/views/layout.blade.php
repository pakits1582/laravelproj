            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/configuration">Configuration</a>
                        <a class="collapse-item" href="/auditlogs">Audit Logs</a>
                        <a class="collapse-item" href="/schools">Schools</a>
                        <a class="collapse-item" href="/colleges">Colleges</a>
                        <a class="collapse-item" href="/departments">Departments</a>
                        <a class="collapse-item" href="/users">User Accounts</a>
                    </div>
                </div>
            </li>
