    ...
    <div class="card-body" id="">
        <div class="form-group">
            ...
            <div class="row align-items-center mb-2">
                ...
                <div class="col-md-9 col-sm-9">
                    <label for="baptism_yes"  class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="baptism" value="1" id="baptism_yes" @if(isset($applicant) && $student->personal_info->baptism == 1) checked @endif> YES </label>
                    <label for="baptism_no"  class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="baptism" value="2" id="baptism_no" @if(isset($applicant) && $student->personal_info->baptism == 2) checked @endif> NO </label>
                    <label for="baptism_na"  class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="baptism" value="3" id="baptism_na"  @if(!isset($applicant) || $student->personal_info->baptism == 3) checked @endif> N/A </label>
                </div>
            </div>
            <div class="row align-items-center mb-2">
                <div class="col-md-3 col-sm-3">
                ...
                <div class="col-md-9 col-sm-9">
                    <label for="communion_yes"  class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="communion" value="1" id="communion_yes" @if(isset($applicant) && $student->personal_info->communion == 1) checked @endif> YES </label>
                    <label for="communion_no"  class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="communion" value="2" id="communion_no" @if(isset($applicant) && $student->personal_info->communion == 2) checked @endif> NO </label>
                    <label for="communion_na"  class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="communion" value="3" id="communion_na" @if(!isset($applicant) || $student->personal_info->communion == 3) checked @endif> N/A </label>
                </div>
            </div>
            <div class="row align-items-center mb-2">
                <div class="col-md-3 col-sm-3">
                ...
                <div class="col-md-9 col-sm-9">
                    <label for="confirmation_yes"  class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="confirmation" value="1" id="confirmation_yes" @if(isset($applicant) && $student->personal_info->confirmation == 1) checked @endif> YES </label>
                    <label for="confirmation_no"  class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="confirmation" value="2" id="confirmation_no" @if(isset($applicant) && $student->personal_info->confirmation == 2) checked @endif> NO </label>
                    <label for="confirmation_na"  class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="confirmation" value="3" id="confirmation_na"  @if(!isset($applicant) || $student->personal_info->confirmation == 3) checked @endif> N/A </label>
                </div>
            </div>
        </div>
    </div>
