        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h6 class="font-weight-bold text-primary mb-0">Admissions <span id="period_name">{{ session('periodname') }}</span></h6>
                    </div>
                    <div class="col-md-6 right">
                        <a href="{{ route('onlineadmissions') }}" class="btn btn-sm btn-primary btn-icon-split">
