@extends('layout')
@section('title') {{ 'Online Admissions' }} @endsection
@section('content')
    <!-- Begin Page Content -->
    <div class="container-fluid">

        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Online Admissions</h1>
        <p class="mb-4">List of online admission applications.</p>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row align-items-center">
                    <div class="col-md-9">
                        <h6 class="font-weight-bold text-primary mb-0">Online Admission Applications <span id="period_name">{{ session('periodname') }}</span></h6>
                    </div>
                    <div class="col-md-3 right">
                        <a href="{{ route('admissions.index') }}" class="btn btn-sm btn-primary btn-icon-split">
            ...
            <div class="card-body">
                ...
                <div id="">
                    @include('admission.return_online_admissions')
                </div>
                <div class="row align-items-center">
                    <div class="col-md-6">
