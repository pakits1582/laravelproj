@extends('layout')
@section('title') {{ 'Adding Dropping' }} @endsection
@section('content')
    <!-- Begin Page Content -->
    <div class="container-fluid">

        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Adding Dropping</h1>
        <p class="mb-4">Student enrolment adding and dropping of subjects form.</p>
                    ...
                    <div class="col-lg-12 mx-auto">
                        <div class="bg-white rounded-lg shadow-sm p-3">
                            ...
                            <div id="nav-tab-card" class="tab-pane fade show active">
                                ...
                                @endif
                                <form method="POST" action=""  role="form" id="form_adddrop">
                                    @csrf
                                    ...
                                    <div class="form-group" id="button_group">
                                        ...
                                        <button type="button" id="withdraw_enrollment" class="btn btn-danger btn-icon-split actions mb-2" disabled>
                                            ...
                                            <span class="text">Withdraw Enrollment</span>
                                        </button>
                                    </div>
                                </form>
                            </div>
