    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="font-weight-bold text-primary mb-0">Masterlist <span id="period_name">{{ session('periodname') }}</span></h6>
            </div>
            <div class="card-body">
                <form method="POST" id="form_filtermasterlist" action="" target="_blank">
                    ...
                    <div class="row mt-3 d-flex align-items-center">
                        ...
                        <div class="col-md-6">
                            <button type="button" id="print_masterlist" class="btn btn-sm btn-danger btn-icon-split actions mb-2">
                                <span class="icon text-white-50">
                                    <i class="fas fa-print"></i>
                                </span>
                                <span class="text">Print PDF</span>
                            </button>
                            <button type="button" id="download_masterlist" class="btn btn-sm btn-success btn-icon-split actions mb-2">
                                <span class="icon text-white-50">
