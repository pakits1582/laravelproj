        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="department" class="m-0 font-weight-bold text-primary">Period</label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="designation" class="m-0 font-weight-bold text-primary">Program</label>
                ...
                <div class="row mt-3 d-flex align-items-center">
                    <div class="col-md-2">
                        <div class="form-group">
                            <h6 class="m-0 font-weight-bold text-primary">Total Students ({{ count($masterlist) }})</h6>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="internal"  class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="source" value="1" id="internal" checked> All </label>
                            <label for="external"  class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="source" value="2" id="external"> Validated </label>    
                            <label for="external"  class="m-0 font-weight-bold text-primary"><input type="radio" class="" name="source" value="2" id="external"> Unpaid </label>    
                        </div>
                    </div>
                    <div class="col-md-6">
