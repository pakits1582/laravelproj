asdasd<form method="POST" action="" id="assessment_form">
    <div>
        <!-- Page Heading -->
        @php
        echo '<pre>';
            ...
            $professional_subjects = array_sum($result['professional']);
            $academic_subjects = array_sum($result['academic']);
            $total_subjects = count($enrollment['enrolled_classes']);

            echo $professional_subjects.'--'.$academic_subjects.'--'. $total_subjects;
