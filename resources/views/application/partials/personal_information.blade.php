<div class="card shadow mb-4">
    ...
    <div class="card-body" id="">
        <div class="form-group" id="postcharge_fees">
            ...
            <div class="row align-items-center mb-1">
                <div class="col-md-3 col-sm-3">
                    <label for="term" class="m-0 font-weight-bold text-primary">* First Name</label>
                </div>
                <div class="col-md-9 col-sm-9">
                    <input type="text" name="keyword" placeholder="" class="form-control" id="keyword">
                </div>
            ...
            <div class="row align-items-center mb-1">
                <div class="col-md-3 col-sm-3">
                    <label for="term" class="m-0 font-weight-bold text-primary">Middle Name</label>
                </div>
                <div class="col-md-9 col-sm-9">
                    <input type="text" name="keyword" placeholder="" class="form-control" id="keyword">
                </div>
            ...
            <div class="row align-items-center mb-1">
                <div class="col-md-3 col-sm-3">
                    <label for="term" class="m-0 font-weight-bold text-primary">Name Suffix</label>
                </div>
                <div class="col-md-9 col-sm-9">
            ...
            <div class="row align-items-center mb-1">
                <div class="col-md-3 col-sm-3">
                    <label for="term" class="m-0 font-weight-bold text-primary">Sex</label>
                </div>
                <div class="col-md-9 col-sm-9">
                    <select name="period_id" class="form-control filter_item" id="period_id">
            ...
            <div class="row align-items-center mb-1">
                <div class="col-md-3 col-sm-3">
                    <label for="term" class="m-0 font-weight-bold text-primary">Civil Status</label>
                </div>
                <div class="col-md-9 col-sm-9">
                    <select name="period_id" class="form-control filter_item" id="period_id">
            ...
            <div class="row align-items-center mb-1">
                <div class="col-md-3 col-sm-3">
                    <label for="term" class="m-0 font-weight-bold text-primary">Birth Date</label>
                </div>
                <div class="col-md-9 col-sm-9">
                    <input type="text" name="keyword" placeholder="" class="form-control" id="keyword">
                </div>
            ...
            <div class="row align-items-center mb-1">
                <div class="col-md-3 col-sm-3">
                    <label for="term" class="m-0 font-weight-bold text-primary">Birth Place</label>
                </div>
                <div class="col-md-9 col-sm-9">
                    <input type="text" name="keyword" placeholder="" class="form-control" id="keyword">
                </div>
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-md-9 col-sm-9">
                    <input type="text" name="keyword" placeholder="IF OTHERS, PLEASE SPECIFY" class="form-control" id="keyword">
                </div>
            </div>
