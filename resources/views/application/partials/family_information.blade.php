                        ...
                        <div class="card-body p-2">                    
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="father_name" placeholder="" class="form-control text-uppercase" id="father_name" maxlength="255" minlength="2">
                                    @error('father_name')
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="father_contactno" placeholder="" class="form-control text-uppercase" id="father_contactno" minlength="4" maxlength="30">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="father_address" placeholder="" class="form-control text-uppercase" id="father_address" maxlength="255" minlength="2">
                        ...
                        <div class="card-body p-2">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="mother_name" placeholder="" class="form-control text-uppercase" id="mother_name" minlength="2" maxlength="255">
                                    @error('mother_name')
                                        <p class="text-danger text-xs mt-1">{{$message}}</p>
                                    @enderror
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="mother_contactno" placeholder="" class="form-control" id="mother_contactno" minlength="2" maxlength="30">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="mother_address" placeholder="" class="form-control text-uppercase" id="mother_address" minlength="2" maxlength="255">
                        ...
                        <div class="card-body p-2">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="guardian_name" placeholder="" class="form-control text-uppercase" id="guardian_name" minlength="2" maxlength="255">
                                    @error('guardian_name')
                                        <p class="text-danger text-xs mt-1">{{$message}}</p>
                                    @enderror
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="guardian_relationship" placeholder="" class="form-control text-uppercase" id="guardian_relationship" minlength="2" maxlength="100">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="guardian_contactno" placeholder="" class="form-control text-uppercase" id="guardian_contactno" minlength="2" maxlength="30">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="guardian_address" placeholder="" class="form-control text-uppercase" id="guardian_address" minlength="2" maxlength="255">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="guardian_occupation" placeholder="" class="form-control text-uppercase" id="guardian_occupation" minlength="2" maxlength="255">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="guardian_employer" placeholder="" class="form-control text-uppercase" id="guardian_employer" minlength="2" maxlength="255">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="guardian_employer_address" placeholder="" class="form-control text-uppercase" id="guardian_employer_address" minlength="2" maxlength="255">
                        ...
                        <div class="card-body p-2">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="occupation" placeholder="" class="form-control text-uppercase" id="occupation" minlength="2" maxlength="255">
                                    @error('occupation')
                                        <p class="text-danger text-xs mt-1">{{$message}}</p>
                                    @enderror
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="employer" placeholder="" class="form-control text-uppercase" id="employer" minlength="2" maxlength="255">
                                    @error('employer')
                                        <p class="text-danger text-xs mt-1">{{$message}}</p>
                                    @enderror
                                </div>
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="employer_address" placeholder="" class="form-control text-uppercase" id="employer_address" minlength="20" maxlength="255">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="employer_contact" placeholder="" class="form-control text-uppercase" id="employer_contact" minlength="2" maxlength="30">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" name="occupation_years" placeholder="" class="form-control" id="occupation_years" minlength="1" maxlength="2">
