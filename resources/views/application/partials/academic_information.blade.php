        ...
        <div class="form-group" id="">
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-lg-2">
                    ...
                    <input type="text" name="elem_period" value="{{ old('elem_period') }}" placeholder="0000-0000" class="form-control col-sm mb-1 text-uppercase" id="elem_period" minlength="4" maxlength="50">
                    @error('elem_period')
                        <p class="text-danger text-xs mt-1">{{$message}}</p>
                    @enderror
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-lg-2">
                    ...
                    <input type="text" name="jhs_period" value="{{ old('jhs_period') }}" placeholder="0000-0000" class="form-control col-sm mb-1 text-uppercase" id="jhs_period" minlength="4" maxlength="50">
                    @error('jhs_period')
                        <p class="text-danger text-xs mt-1">{{$message}}</p>
                    @enderror
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-lg-2">
                    ...
                    <input type="text" name="shs_period" value="{{ old('shs_period') }}" placeholder="0000-0000" class="form-control col-sm mb-1 text-uppercase" id="shs_period" minlength="4" maxlength="50">
                    @error('shs_period')
                        <p class="text-danger text-xs mt-1">{{$message}}</p>
                    @enderror
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-lg-2">
                    ...
                    <input type="text" name="college_period" value="{{ old('college_period') }}" placeholder="0000-0000" class="form-control col-sm mb-1 text-uppercase" id="college_period" minlength="4" maxlength="50">
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-lg-2">
                    ...
                    <input type="text" name="graduate_period" value="{{ old('graduate_period') }}" placeholder="0000-0000" class="form-control col-sm mb-1 text-uppercase" id="graduate_period" minlength="4" maxlength="50">
